...
def cross_validate(stats):
    ...
    for i in range(num_tasks):
        ...
        task_train_accuracies = [train_accs[i]['post_accuracy_train'] for i in range(len(train_accs))]
        task_val_accuracies = [val_accs[i]['post_accuracy_train'] for i in range(len(val_accs))]
...
def cli_main(args):
    ...
    if args.distributed_init_method is not None:
        ...
        # single GPU training
        train_stats, valid_stats = main(args)
