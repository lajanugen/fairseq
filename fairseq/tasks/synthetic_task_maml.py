...
class SyntheticLMMAMLTask(ReviewTask):

    @staticmethod
    def add_args(parser):
        super(SyntheticLMMAMLTask, SyntheticLMMAMLTask).add_args(parser)
...
#            val_examples = [task[0] for task in val_tasks]
            val_examples = [task[1] for task in train_tasks]
