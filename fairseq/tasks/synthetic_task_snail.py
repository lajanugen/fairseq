...
@register_task('synthetic_lm_task_snail')
class SyntheticLMTaskSnail(ReviewTask):

    @staticmethod
    def add_args(parser):
        super(SyntheticLMTaskSnail, SyntheticLMTaskSnail).add_args(parser)
        ...
        if self.train_unseen_task:
            ...
            if split == 'valid':
                ...
                for i in range(len(input_sentences)):
                    input_sentences[i] = torch.cat([train_input_sentences, input_sentences[i]])
